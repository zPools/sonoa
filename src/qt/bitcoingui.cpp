...
void BitcoinGUI::createActions()
{
    ...
    blockAction->setToolTip(tr("Explore the SONO Blockchain"));
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a SONO address"));
    ...
    masternodeManagerAction->setToolTip(tr("Show SONO Masternodes status and configure your nodes."));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About SONO"), this);
    aboutAction->setToolTip(tr("Show information about SONO"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for SONO"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("SONO client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("SONO client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SONO network", "", count));
}
...
void BitcoinGUI::setNumBlocks(int count, int nTotalBlocks)
{
    ...
    {
        progressBarLabel->setText(tr("Connecting to SONO network..."));
...
void BitcoinGUI::showConfEditor()
{
    ...
    /* Open sono.conf with the associated application */
    if (boost::filesystem::exists(pathConfig)) {
        QDesktopServices::openUrl(QUrl::fromLocalFile(QString::fromStdString(pathConfig.string())));
	} else {
		QMessageBox::warning(this, tr("No sono.conf"),
        tr("Your sono.conf does not exist! Please create one in your SONO data directory."),
...
void BitcoinGUI::showMNConfEditor()
{
    ...
    if (boost::filesystem::exists(pathMNConfig)) {
        ...
        tr("Your masternode.conf does not exist! Please create one in your SONO data directory."),
        QMessageBox::Ok, QMessageBox::Ok);
	}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid SONO address or malformed URI parameters."));
    }
...
void BitcoinGUI::updateStakingIcon()
{
    ...
    else
    {
        ...
        if (pwalletMain && pwalletMain->IsLocked())
            ...
            labelStakingIcon->setToolTip(tr("Not staking<br> Does you wallet have more than 3 connections<br>and have masternodes in list?"));
    }
}
