...
void StatisticsPage::updateStatistics()
{
	...
	int64_t marketcap = SONOmarket.toDouble();
    ...
    QString mn = "1,000 SONO";
    QString mn2 = "25% of PoW/PoS block reward";
    ...
    {
        ui->volumeBox->setText("<b><font color=\"yellow\">" + qVolume + " SONO" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " SONO" + "</font></b>");
    } else {
        ui->volumeBox->setText("<b><font color=\"orange\">" + qVolume + " SONO" + "</font></b>");
    }
