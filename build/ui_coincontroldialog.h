...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 SONO"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 SONO"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 SONO"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 SONO"));
