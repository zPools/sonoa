...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "SONO - Debug window", 0));
        label_9->setText(QApplication::translate("RPCConsole", "SONO Core", 0));
        ...
        label_8->setText(QApplication::translate("RPCConsole", "Testnet On/Off", 0));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the SONO debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the SONO-Qt help message to get a list with possible SONO command-line options.", 0));
#endif // QT_NO_TOOLTIP
