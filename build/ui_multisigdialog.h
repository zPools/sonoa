...
public:
    ...
    void setupUi(QWidget *MultisigDialog)
    {
        ...
        label->setText(QStringLiteral("<strong>SONO</strong>"));
        ...
        label_2->setText(QStringLiteral("<strong>SONO</strong>"));
        ...
        label_3->setText(QStringLiteral("<strong>SONO</strong>"));
...
#ifndef QT_NO_TOOLTIP
        pasteTransactionButton->setToolTip(QApplication::translate("MultisigDialog", "Paste transaction from clipboard", 0));
#endif // QT_NO_TOOLTIP
