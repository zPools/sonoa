...
struct qt_meta_stringdata_MintingFilterProxy_t {
    QByteArrayData data[1];
    char stringdata0[19];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_MintingFilterProxy_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MintingFilterProxy_t qt_meta_stringdata_MintingFilterProxy = {
    {
QT_MOC_LITERAL(0, 0, 18) // "MintingFilterProxy"
...
const QMetaObject MintingFilterProxy::staticMetaObject = {
    { &QSortFilterProxyModel::staticMetaObject, qt_meta_stringdata_MintingFilterProxy.data,
      qt_meta_data_MintingFilterProxy,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MintingFilterProxy::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MintingFilterProxy.stringdata0))
