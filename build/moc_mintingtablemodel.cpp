...
struct qt_meta_stringdata_MintingTableModel_t {
    QByteArrayData data[3];
    char stringdata0[26];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_MintingTableModel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MintingTableModel_t qt_meta_stringdata_MintingTableModel = {
    {
QT_MOC_LITERAL(0, 0, 17), // "MintingTableModel"
QT_MOC_LITERAL(1, 18, 6), // "update"
QT_MOC_LITERAL(2, 25, 0) // ""

    },
    "MintingTableModel\0update\0"
};
...
const QMetaObject MintingTableModel::staticMetaObject = {
    { &QAbstractTableModel::staticMetaObject, qt_meta_stringdata_MintingTableModel.data,
      qt_meta_data_MintingTableModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MintingTableModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MintingTableModel.stringdata0))
