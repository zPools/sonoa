...
read -p "This script will remove QT4 and do a autoremove. 
If you need to keep it, please install the dependencies manual
Do you want to continue? (Type y if you want) " -n 1 -r
if [[ ! $REPLY =~ ^[Yy]$ ]]
then
